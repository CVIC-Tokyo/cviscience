  ...
  return (
    <div className='page-container flex items-center justify-center p-4 md:p-16 tracking-wide'>
      <div className='w-full md:w-[90%] h-auto p-2 md:p-12'>
        <h1 className='text-lg h-auto p-2 text-white bg-cvic-red flex justify-center items-center'>{localeData.ABOUT.MISSION_TITLE}</h1>
        <p>{localeData.ABOUT.MISSION}</p>
        <h1 className='text-lg h-auto p-2 text-white bg-cvic-red flex justify-center items-center'>{localeData.ABOUT.VISION_TITLE}</h1>
        <p>{localeData.ABOUT.VISION}</p>
        <h1 className='text-lg h-auto p-2 text-white bg-cvic-red flex justify-center items-center'>{localeData.ABOUT.CSR_TITLE}</h1>

    ...
    <div
      ...
      <div className="absolute top-0 left-0 w-full h-full flex items-center justify-center hover:bg-black/25">
        ...
        >
          ...
          <Link href={"/pages/services"} className="my-2 p-2 h-[8px] w-auto md:h-[20px] lg:h-[30px] rounded bg-white/75 border-4 border-white/10 hover:bg-white flex items-center justify-center cursor-pointer">

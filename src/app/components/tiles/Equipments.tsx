...
const Equipments: React.FC<EquipmentsProps> = () => {
  ...
  return (
    <div className="tile-container"
      ...
      ref={containerRef}
    >
      <div className="w-full h-[280px] md:h-[70vh] overflow-hidden relative border-y-8 border-white shadow-2xl">
        <div
          style={{
        ...
        <div className="absolute top-0 left-0 w-full h-full flex items-center justify-center hover:bg-black/25">
          ...
          >
            ...
            <Link href={"/pages/equipments"} className="my-2 p-2 h-[8px] w-auto md:h-[20px] lg:h-[30px] rounded bg-white/75 hover:bg-white flex items-center justify-center cursor-pointer">
